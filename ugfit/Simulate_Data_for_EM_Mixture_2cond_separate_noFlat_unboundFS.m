...
%         good = good +1;
        ...
        [offer_nc_1, choice_nc_1] = simulate_1step_nc_unboundFS(gen_params(i,1:5));
        ...
        [offer_nc_2, choice_nc_2] = simulate_2step_nc_unboundFS(gen_params(i,1:5));
        ...
        [offer_nc_3, choice_nc_3] = simulate_3step_nc_unboundFS(gen_params(i,1:5));
...
%%
save('Hackathon-Data_Separate-IC-NC_s150_noFlat_unboundFS.mat', 's');
