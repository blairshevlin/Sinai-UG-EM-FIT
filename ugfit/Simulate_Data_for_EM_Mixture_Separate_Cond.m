...
for i = 1:nP
    ...
    [offer_nc, choice_nc] = simulate_1step_nc(gen_params(i,1:5));
...
for i = 1:nP
    ...
    [offer_nc, choice_nc] = simulate_2step_nc(gen_params(i,1:5));
...
for i = 1:nP
    ...
    [offer_nc, choice_nc] = simulate_3step_nc(gen_params(i,1:5));
...
save('Hackathon-Data_Separate-IC-NC_s150.mat', 's');
