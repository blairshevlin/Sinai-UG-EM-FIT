function [modout]= EMfit_Algo2_ms(rootfile,modelID,quickfit,trials)
...
fit.options = optimoptions(@fminunc,'Display','off','TolX',.0001,'Algorithm','quasi-newton','HessUpdate', 'bfgs'); 
if isfield(fit,'maxEvals'),  fit.options = optimoptions(@fminunc,'Display','off','TolX',.0001,'MaxFunEvals', fit.maxEvals,'Algorithm','quasi-newton','HessUpdate', 'bfgs'); end
