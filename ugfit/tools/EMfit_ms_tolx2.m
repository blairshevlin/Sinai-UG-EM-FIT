function [modout]= EMfit_ms_tolx2(rootfile,modelID,quickfit,trials)
...
% Note: reduced TolX to .01 (Original is .001)
fit.options = optimoptions(@fminunc,'Display','off','TolX',.01,'Algorithm','quasi-newton'); 
if isfield(fit,'maxEvals'),  fit.options = optimoptions(@fminunc,'Display','off','TolX',.01,'MaxFunEvals', fit.maxEvals,'Algorithm','quasi-newton'); end
