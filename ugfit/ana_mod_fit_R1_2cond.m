...
load('DATA_Simulated-Gauss_f0_250Subj_2cond_30Trials_Dec15.mat');
...
M.modid     = { %'ms_UG0_f0f_adaptiveNorm', ...
     %'ms_UG1_etaf_f0f_adaptiveNorm',...
      'ms_UG2_etaf_f0f_adaptiveNorm_2cond'}; %, ...
   ...
   for im = 1:numel(M.modid)
      ...
      while 1==dotry
         try
            ...
            s.(cur_exp).em = EMfit_2cond_ms(s.(cur_exp),M.modid{im},M.quickfit);
            dotry=0;
         catch
            dotry=1; disp('caught');
         end
