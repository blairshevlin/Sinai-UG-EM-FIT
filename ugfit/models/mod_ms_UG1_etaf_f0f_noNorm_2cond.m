function [fval,fit] = mod_ms_UG1_etaf_f0f_noNorm_2cond(behavData,q, doprior,dofit,varargin)
...
[qt, bounds] = norm2par('ms_UG1_etaf_f0f_noNorm_2cond',q); % transform parameters from gaussian space to model space
...
%end
if doprior == 1
    [fval,~,~,ChoiceProb] = lik_UG1_etaf_f0f_noNorm_2cond(behavData.offer, behavData.choice,fixed,free,doprior,prior,q);
else
    [fval,~,~,ChoiceProb] = lik_UG1_etaf_f0f_noNorm_2cond(behavData.offer, behavData.choice,fixed,free,doprior);
