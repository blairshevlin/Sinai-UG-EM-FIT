function [fval,fit] = mod_ms_UG2_etaf_f0f_noNorm(behavData,q, doprior,dofit,varargin)
...
[qt, bounds] = norm2par('ms_UG2_etaf_f0f_noNorm',q); % transform parameters from gaussian space to model space
...
if doprior == 1
    [fval,~,ChoiceProb] = lik_UG2_etaf_f0f_noNorm(behavData.offer, behavData.choice,fixed,free,doprior,prior,q);
else
    [fval,~,ChoiceProb] = lik_UG2_etaf_f0f_noNorm(behavData.offer, behavData.choice,fixed,free,doprior);
