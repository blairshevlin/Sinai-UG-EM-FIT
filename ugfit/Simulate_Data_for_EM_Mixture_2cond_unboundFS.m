...
for i = 1:nP
    ...
    [offer_nc, choice_nc] = simulate_1step_nc_unboundFS(gen_params(i,[1:4,6]));
...
for i = 1:nP
    ...
    [offer_nc, choice_nc] = simulate_2step_nc_unboundFS(gen_params(i,[1:4,6]));
...
for i = 1:nP
    ...
    [offer_nc, choice_nc] = simulate_3step_nc_unboundFS(gen_params(i,[1:4,6]));
...
save('Hackathon-Data_Combined-IC-NC_s150_unboundFS.mat', 's');
