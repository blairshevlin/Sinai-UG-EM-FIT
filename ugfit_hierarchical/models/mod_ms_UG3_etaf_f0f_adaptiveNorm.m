...
% -------------------------------------------------------------------------------------
if doprior == 1
    [fval,norm,V,ChoiceProb] = lik_UG3_etaf_f0f_adaptiveNorm(behavData.offer, behavData.choice,fixed,free,doprior,prior,q);
else
    [fval,norm,V,ChoiceProb] = lik_UG3_etaf_f0f_adaptiveNorm(behavData.offer, behavData.choice,fixed,free,doprior);
