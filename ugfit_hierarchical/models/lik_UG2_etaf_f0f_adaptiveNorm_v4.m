function [fval, norm, V, ChoiceProb] = lik_UG2_etaf_f0f_adaptiveNorm_v4(offer, resp, fixed, free, doprior, varargin)
   %v4 increases the size of the likelihood across the entire likelihood
    ...
    log_probs = log(ChoiceProb*10);
    early = 1:(n/2);
    late = (n/2)+1:n;
    log_probs(early) = log_probs(early);
