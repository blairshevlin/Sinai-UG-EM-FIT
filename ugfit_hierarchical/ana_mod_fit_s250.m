...
load('DATA_Simulated-Normal_f0_250Subj_30Trials_Nov9.mat');
   ...
   for im = 1:numel(M.modid)
      ...
      while 1==dotry
         try
            ...
            s.(cur_exp).em = EMfit_Algo2_ms(s.(cur_exp),M.modid{im},M.quickfit,trials);
            dotry=0;
         catch
            dotry=1; disp('caught');
         end
...
save('FIT_OG_Algo2_Simulated_f0_s250_t30.mat','s')


%%

load("FIT_Weightedv8_Algo2_Simulated_f0_s250_t30.mat")
