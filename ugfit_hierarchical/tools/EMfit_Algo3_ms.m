function [modout]= EMfit_Algo3_ms(rootfile,modelID,quickfit,trials)
...
fit.options = optimoptions(@fminunc,'Display','off','TolX',.0001,'Algorithm','interior-point'); 
if isfield(fit,'maxEvals'),  fit.options = optimoptions(@fminunc,'Display','off','TolX',.0001,'MaxFunEvals', fit.maxEvals,'Algorithm','interior-point'); end
