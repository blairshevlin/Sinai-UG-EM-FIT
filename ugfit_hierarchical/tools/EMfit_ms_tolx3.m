function [modout]= EMfit_ms_tolx3(rootfile,modelID,quickfit,trials)
...
fit.options = optimoptions(@fminunc,'Display','off','TolX',.001,'Algorithm','quasi-newton'); 
if isfield(fit,'maxEvals'),  fit.options = optimoptions(@fminunc,'Display','off','TolX',.001,'MaxFunEvals', fit.maxEvals,'Algorithm','quasi-newton'); end
